...
services:
  caddy:
    ...
    ports:
      - "8080:80"      # Internal HTTP port for HAProxy backends
      - "8443:443"     # Internal HTTPS port for HAProxy backends
...
networks:
  ...
  async generateCompleteCaddyfile(clusterRoutes: Array<{host: string; healthPath?: string}>): Promise<void> {
    ...
    // Generate complete Caddyfile with admin interface and route blocks
    const completeCaddyfile = `# Dynia Caddyfile - managed by Dynia CLI
# This file is automatically generated and updated by Dynia
